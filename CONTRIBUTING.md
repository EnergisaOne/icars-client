...
Thank you for your interest in `icars-client`, an open source project
administered by StrongLoop.

Contributing to `icars-client` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/icars-client)
